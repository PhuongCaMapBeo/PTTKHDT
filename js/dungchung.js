...
function signUp(form) {
    ...
    var newUser = new User(username, pass, ho, ten,address,phone,email);
...
function addFooter() {
    ...
    <div class="copy-right">
        <p><a href="index.html">Smart Phone Store</a> - since 2023 - Designed by
                ...
                <div id="signup">
                    ...
                    <form onsubmit="return signUp(this);">
                        ...
                        <div class="field-wrap">
                            ...
                            <input name="phone" type="phone" required autocomplete="off" />
                        </div> <!-- /phone -->
                        <div class="field-wrap">
                            <label>
