...
function addProductToTable(user) {
	...
	if (!user) {
		...
		s += `
			<tr>
				<td colspan="7"> 
					<h1 style="color:var(--color-primary); background-color:white; font-weight:bold; text-align:center; padding: 15px 0;">
						Giỏ hàng trống !!
					</h1> 
				</td>
			</tr>
...
function thanhToan() {
	...
	var listSanPham = document.querySelector('.listSanPham');
	listSanPham.classList.add("hidden")
